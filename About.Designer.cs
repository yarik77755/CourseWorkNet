namespace Курсовая_2
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "База данных комиссии ИТ";
            ...
            this.labelCompanyName.Text = "Одесский Технический Колледж ОНАХТ";
            ...
            this.textBoxDescription.Text = "Программа создана для работы с базой данных. Для открытия существующей БД восполь" +
    "зуйтесь командой Файл->Открыть";
            // 
            // okButton
            // 
